  ...
  return (
    ...
    >
      ...
      >
        ...
        <p
          style={{ fontSize: 14, color: 'var(--adm-text-sec)', lineHeight: 1.5, marginBottom: 20 }}
        >
        ...
        {txosnak.map((tx) => (
          ...
          >
            ...
            >
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                <span style={{ fontSize: 12, color: STATUS_COLOR[tx.status], fontWeight: 600 }}>
                  {STATUS_LABEL[tx.status]}
                </span>
                {tx.waitMinutes && (
                  <span style={{ fontSize: 12, color: 'var(--adm-text-sec)' }}>
                    ⏱ {tx.waitMinutes} min
                  </span>
                )}
              </div>
