 ...
 * Update txosna settings. Requires ADMIN role.
 * Only writable fields: status, waitMinutes, counterSetup, enabledChannels,
...
export async function PATCH(req: NextRequest, { params }: { params: Promise<{ slug: string }> }) {
  ...
  try {
    ...
    // Broadcast SSE only if status changed to PAUSED or CLOSED
