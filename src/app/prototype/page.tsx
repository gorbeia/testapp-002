...
const screens = [
  {
    ...
    items: [
      ...
      { name: "Eskaera Baieztapena", route: `${LOCALE}/${SLUG}/checkout`, desc: "Cart summary, place order" },
      { name: "Eskaera Egoera", route: `${LOCALE}/order/order-1`, desc: "Post-order status, live updates" },
      { name: "Frogagirria (Pickup Proof)", route: `${LOCALE}/order/order-1/proof`, desc: "Show at pickup — high contrast" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Janari Mostradore", route: `${LOCALE}/counter`, desc: "Food counter — pending, new order, ready" },
      { name: "Edari Mostradore", route: `${LOCALE}/drinks`, desc: "Drinks counter — POS grid" },
      { name: "Sukalde (KDS)", route: `${LOCALE}/kitchen`, desc: "Kitchen Display System — Kanban" },
      { name: "Egoera Ikuspegi", route: `${LOCALE}/overview`, desc: "Status overview — live snapshot" },
    ],
  },
  {
    ...
    <div style={{ minHeight: "100vh", background: "#0f172a", color: "#f1f5f9", fontFamily: "system-ui, sans-serif" }}>
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "40px 20px" }}>
        ...
        <div style={{ marginBottom: 40 }}>
          <div style={{ fontSize: 12, letterSpacing: "0.12em", textTransform: "uppercase", color: "#64748b", marginBottom: 8 }}>
