  ...
  return text.split('\n').map((line, i) => {
    ...
    if (/^\d+\./.test(line))
      return (
        <p
          key={i}
          style={{ color: 'var(--ops-text-pri)', margin: '0 0 6px', fontSize: 14, paddingLeft: 8 }}
        >
          {line}
        </p>
      );
    if (line.startsWith('- '))
      return (
        <p
          key={i}
          style={{ color: 'var(--ops-text-sec)', margin: '0 0 4px', fontSize: 13, paddingLeft: 12 }}
        >
          • {line.slice(2)}
        </p>
      );
      ...
      return (
        <p
          ...
          style={{
            ...
            fontSize: 13,
            paddingLeft: 12,
            borderLeft: '3px solid var(--ops-amber, #f59e0b)',
          }}
        >
          {line.slice(2)}
        </p>
    ...
    return (
      <p key={i} style={{ color: 'var(--ops-text-sec)', margin: '0 0 6px', fontSize: 13 }}>
        {line}
      </p>
    );
  });
    ...
    return (
      ...
      >
        ...
        >
          ...
          <div style={{ color: 'var(--ops-text-sec)', fontSize: 15 }}>
            Eskaera honentzat ez dago prestaketa argibiderik.
          </div>
          <button
            onClick={onClose}
            style={{
