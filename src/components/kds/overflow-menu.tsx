  ...
  return (
    <div ref={ref} style={{ position: 'relative' }}>
      <button
        onClick={() => setOpen((o) => !o)}
        style={{
          background: open ? 'var(--ops-surface-hi)' : 'transparent',
          border: `1px solid ${open ? 'var(--ops-border)' : 'transparent'}`,
          borderRadius: 8,
          padding: '7px 10px',
      ...
      {open && (
        ...
        >
          <button
            onClick={() => {
              setOpen(false);
              setConfirm(paused ? 'resume' : 'pause');
            }}
            style={{
              display: 'flex',
              alignItems: 'center',
              ...
              borderRadius: 8,
              padding: '10px 14px',
              color: paused ? 'var(--ops-green)' : 'var(--ops-text-sec)',
              fontSize: 14,
              cursor: 'pointer',
              textAlign: 'left',
            }}
