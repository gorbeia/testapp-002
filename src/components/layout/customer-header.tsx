      ...
      <div className="flex items-center justify-between gap-3 px-4 h-14">
        <div className="flex items-center gap-2 min-w-0">
          ...
          <span
            ...
            style={{
              background: status === "OPEN" ? "rgba(34,197,94,0.15)" : status === "PAUSED" ? "rgba(245,158,11,0.15)" : "var(--cust-surface-hi)",
              color: status === "OPEN" ? "#22c55e" : status === "PAUSED" ? "#f59e0b" : "var(--cust-text-sec)",
            }}
          >
            {sc.label}
          </span>
