...
export function OpsHeader({ title, subtitle, left, right, statusColor = 'green' }: OpsHeaderProps) {
  return (
    <header
      style={{
    ...
    >
      <div className="flex items-center gap-3 min-w-0">
        {left}
        <span className={`w-2 h-2 rounded-full flex-shrink-0 ${STATUS_DOT[statusColor]}`} />
