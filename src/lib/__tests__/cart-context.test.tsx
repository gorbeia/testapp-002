...
function Harness() {
  ...
  return (
    <div>
      ...
      <button onClick={() => cart.addItem(makeItem({ selectedVariant: "Grande" }))}>add-variant</button>
      <button onClick={() => cart.addItem(makeItem({ productId: "prod-2", productName: "Txorizoa" }))}>add-other</button>
