    ...
    variantGroups: [
      {
        ...
        name: 'Albokoa',
        options: [
          { id: 'demo-vo-1', name: 'Patata frijituak', priceDelta: 0, kitchenPost: 'assembly' },
...
export const DEMO_ORDERS: MockOrder[] = [
  ...
  {
    // Fully served counter order — shows COMPLETED lifecycle end state
    id: 'demo-order-7',
    orderNumber: 7,
    status: 'COMPLETED',
    customerName: 'Nerea',
  ...
  {
    // Fully served self-service order — drinks only, COMPLETED
    id: 'demo-order-8',
    orderNumber: 8,
    status: 'COMPLETED',
    customerName: 'Koldo',
...
export const DEMO_TICKETS: MockTicket[] = [
  ...
  {
    // Order 7 — food ticket fully served (COMPLETED)
    id: 'demo-ticket-9',
